...
class MPU_STK(nn.Module):
    def __init__(self, DEVICE, save_path, load_path, pos_bit=1, method='MPU_STK'):
        super(MPU_STK, self).__init__()
        model = 'AIGC_detector_env2'
